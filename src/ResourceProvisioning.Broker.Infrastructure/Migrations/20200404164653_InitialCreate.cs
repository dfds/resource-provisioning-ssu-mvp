	...
	public partial class InitialCreate : Migration
	{
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				{
					Id = table.Column<Guid>(nullable: false),
					DesiredState_Option1 = table.Column<string>(nullable: true),
					DesiredState_Option2 = table.Column<string>(nullable: true),
					DesiredState_Option3 = table.Column<string>(nullable: true),
					DesiredState_Option4 = table.Column<string>(nullable: true),
